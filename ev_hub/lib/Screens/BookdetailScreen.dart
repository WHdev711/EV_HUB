...
class _BookdetailScreen extends State<BookdetailScreen> {
  ...
  Widget _formdWidget() {
    return Column(
      children: <Widget>[
        _entryField("Connector type"),
        _entryField("Date"),
        _entryField("Starttime", isPassword: true),
        _entryField("Endtime", isPassword: true),
      ],
    );
  }
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
            title: Text('My booking details', style: TextStyle(color: Colors.green[900]))),
        body: Container(
